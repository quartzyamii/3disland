...
const Popup = ({ onClose, isClosing = false }) => {
          ...
          .star-float-4 {
                  ...
                  <animated.div style={starFade} className="fixed inset-0 z-40 pointer-events-none">
                    ...
                    <div className="absolute top-[10%] left-[5%]">
                      <img 
                        ...
                        alt="Background Star" 
                        className="w-24 h-24 star-float-1 opacity-00"
                      />
                    </div>
            ...
            >
              <div className="flex justify-center items-center gap-2">
                <h1 className="popup-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-1"
                    style={{ filter: 'drop-shadow(4px 4px 8px rgba(19, 28, 63, 0.6))' }}>
                  2
                </h1>
                <h1 className="popup-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-2"
                    style={{ filter: 'drop-shadow(4px 4px 8px rgba(19, 28, 63, 0.6))' }}>
                  0
                </h1>
                <h1 className="popup-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-3"
                    style={{ filter: 'drop-shadow(4px 4px 8px rgba(19, 28, 63, 0.6))' }}>
                  2
                </h1>
                <h1 className="popup-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-4"
                    style={{ filter: 'drop-shadow(4px 4px 8px rgba(19, 28, 63, 0.6))' }}>
                  4
                </h1>
              </div>
    ...
    {/* 이미지 추가 */}
                        ...
                        >
                          <div className="relative">
                            <img
                              src="/assets/images/GlowstickPopup.png"
                              alt="GlowstickPopup"
