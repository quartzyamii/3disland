...
const KeyRingPopup = ({ onClose, isClosing = false }) => {
    ...
    <>
      ...
      >
        <div className="flex justify-center items-center gap-2">
          <h1 className="keyring-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-1"
              style={{ filter: 'drop-shadow(4px 4px 8px rgba(56, 189, 248, 0.6))' }}>
            2
          </h1>
          <h1 className="keyring-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-2"
              style={{ filter: 'drop-shadow(4px 4px 8px rgba(56, 189, 248, 0.6))' }}>
            0
          </h1>
          <h1 className="keyring-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-3"
              style={{ filter: 'drop-shadow(4px 4px 8px rgba(56, 189, 248, 0.6))' }}>
            1
          </h1>
          <h1 className="keyring-year text-10xl font-bold text-white opacity-100 animate-bounce-slow-4"
              style={{ filter: 'drop-shadow(4px 4px 8px rgba(56, 189, 248, 0.6))' }}>
            0
          </h1>
        </div>
    ...
    {/* 이미지 추가 */}
                            ...
                            >
                              <div className="relative">
                                <img
                                  src="/assets/images/KeyRingPopup.png"
                                  alt="KeyRingPopup"
